...
describe("generateNetworkGenealogiesLoad", () => {
  describe("for arbitrary batches of networks from an arbitrary set of arbitrarily forked blockchains", () => {
    ...
    testProp(
      ...
      // fails when never superseding input
      // { seed: -166416669, path: "1:438:0:3:3:2:4:4", endOnFailure: true }

      // fails when always superseding input
      // { seed: 1122273363, path: "46:326:3:5:7", endOnFailure: true }
    );
  });
});
